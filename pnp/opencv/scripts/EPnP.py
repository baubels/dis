...
class EPnP(object):
    ...
    def handle_general_EPnP(self, Xworld, Ximg_pix, A):
        ...
        for row in M:
            row_add = []
            for item in row:
                try:        row_add.append(item[0])
                except:     row_add.append(item)
            output.append(row_add)
        M = output
        self.K = self.kernel_noise(M, 4)
        Rt_sol, Cc_sol, Xc_sol, sc_sol, beta_sol, errors = [], [], [], [], [], []
    ...
    def efficient_pnp_gauss(self, Xworld, Ximg_pix, A):                                                 # Xworld, Ximg_pix, A
        ...
        return error_best, Rt_best, Cc_best, Xc_best                                                    # error_best, Rt_best, Cc_best, Xc_best                                 
